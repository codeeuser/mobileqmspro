...
class S {
  ...
  String get printToken {
    return Intl.message('Print Token', name: 'printToken', desc: '', args: []);
  }
  ...
  String get statusQueue {
    return Intl.message('Status', name: 'statusQueue', desc: '', args: []);
  }
  ...
  /// `My Queue`
  String get myQueue {
    return Intl.message('My Queue', name: 'myQueue', desc: '', args: []);
  }
  ...
  /// `Re-Call`
  String get recall {
    return Intl.message('Re-Call', name: 'recall', desc: '', args: []);
  }

  /// `Call Token`
  String get callToken {
    return Intl.message('Call Token', name: 'callToken', desc: '', args: []);
  }

  /// `Issue Token`
  String get issueToken {
    return Intl.message('Issue Token', name: 'issueToken', desc: '', args: []);
  }
  ...
  /// `Pair Code`
  String get pairCode {
    return Intl.message('Pair Code', name: 'pairCode', desc: '', args: []);
  }
  ...
  String get visitUsAt {
    return Intl.message('Visit us at', name: 'visitUsAt', desc: '', args: []);
  }
  ...
  /// `Page Size`
  String get pageSize {
    return Intl.message('Page Size', name: 'pageSize', desc: '', args: []);
  }
  ...
  String get editWindow {
    return Intl.message('Edit Window', name: 'editWindow', desc: '', args: []);
  }
  ...
  String get windowForm {
    return Intl.message('Window Form', name: 'windowForm', desc: '', args: []);
  }

  /// `Window Name`
  String get windowName {
    return Intl.message('Window Name', name: 'windowName', desc: '', args: []);
  }
  ...
  /// `Add Logo`
  String get addLogo {
    return Intl.message('Add Logo', name: 'addLogo', desc: '', args: []);
  }

  /// `Remove Logo`
  String get removeLogo {
    return Intl.message('Remove Logo', name: 'removeLogo', desc: '', args: []);
  }
  ...
  String get addWindow {
    return Intl.message('Add Window', name: 'addWindow', desc: '', args: []);
  }
  ...
  String get tokenList {
    return Intl.message('Token List', name: 'tokenList', desc: '', args: []);
  }
  ...
  /// `No Action`
  String get noAction {
    return Intl.message('No Action', name: 'noAction', desc: '', args: []);
  }
